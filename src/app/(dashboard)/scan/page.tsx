  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-screen p-6 py-12 bg-white">
      ...
      <div className="w-full text-center">
        <h1 className="text-2xl font-black text-[#1A6B4A] uppercase tracking-tighter mb-2">
      ...
      <div className="relative flex items-center justify-center w-64 h-64">
          ...
          {isScanning && (
            <>
              <motion.div
                ...
                className="absolute w-full h-full border-4 border-[#1A6B4A] rounded-full"
              />
              <motion.div
                initial={{ scale: 0.8, opacity: 0 }}
        ...
        <motion.div
          ...
          className={cn(
            ...
            status === 'error' ? "bg-red-500" : "bg-[#1A6B4A]"
          )}
        >
          {status === 'error' ? (
        ...
        {isScanning && (
          <motion.div 
            ...
            className="absolute -bottom-12 font-black text-2xl text-[#1A6B4A]"
          >
            {Math.round(progress)}%
          </motion.div>
        )}
      ...
      <div className="w-full space-y-6">
        {status === 'idle' ? (
          ...
          <div className="space-y-4">
            ...
            <p className="text-[10px] text-center font-bold text-slate-400 uppercase tracking-widest flex items-center justify-center gap-2">
              <Loader2 size={12} className="animate-spin text-[#1A6B4A]" />
        ...
        <div className="flex items-center justify-center gap-6 text-slate-400">
           <div className="flex items-center gap-1">
             <CheckCircle2 size={14} className="text-[#1A6B4A]" />
