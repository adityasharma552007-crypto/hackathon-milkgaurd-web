    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <header className="px-5 pt-12 pb-4 bg-white">
        <div className="flex items-center justify-between mb-1">
          ...
          <h1 className="text-xl font-black text-[#1A6B4A] uppercase tracking-tighter">Device</h1>
              ...
              {!pairedDevice ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 text-center gap-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-3 bg-[#1A6B4A] text-white text-sm font-black rounded-2xl hover:bg-[#145339] transition-colors"
                  >
                ...
                <>
                  ...
                  <div className="rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                    ...
                    <div className={`px-5 py-4 flex items-center justify-between ${
                      isConnected ? 'bg-[#1A6B4A]' : 'bg-slate-700'
                    }`}>
                  ...
                  {testPhase === 'idle' && (
                    <motion.button
                      ...
                      className="w-full flex items-center justify-center gap-2.5 py-5 bg-[#1A6B4A] disabled:bg-slate-200 text-white disabled:text-slate-400 rounded-2xl font-black text-base tracking-tight hover:bg-[#145339] transition-colors shadow-lg shadow-green-900/20"
                    >
                      {isConnecting ? (
          ...
          {tab === 'scanner' && (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-4 rounded-2xl border-2 border-dashed border-[#1A6B4A]/30 text-[#1A6B4A] font-black text-sm hover:bg-[#1A6B4A]/5 transition-colors disabled:opacity-60"
              >
                {scanLoading ? (
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="w-full h-11 bg-slate-50 border border-slate-200 rounded-xl px-3 text-sm font-bold focus:outline-none focus:border-[#1A6B4A]"
                />
              ...
              <button
                ...
                className="w-full py-3 bg-[#1A6B4A] text-white rounded-xl font-black text-sm hover:bg-[#145339] transition-colors"
              >
                Save & Scan
              </button>
              ...
              {/* Demo mode info */}
              <div className="flex items-start gap-2 bg-[#1A6B4A]/5 px-3 py-2.5 rounded-xl">
                <Zap size={14} className="text-[#1A6B4A] shrink-0 mt-0.5" />
                <p className="text-[10px] text-[#1A6B4A] font-medium leading-relaxed">
