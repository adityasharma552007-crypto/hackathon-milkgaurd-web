    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.scoreCard}>
          ...
          <Text style={{ fontSize: 14, fontWeight: 'bold', color: scan.result_tier === 'safe' ? '#1A6B4A' : '#EF4444', marginTop: 10 }}>
        ...
        <View style={styles.table}>
          ...
          {scan.adulterant_results?.map((res: any) => (
            <View key={res.id} style={styles.tableRow}>
              ...
              <Text style={[styles.td, styles.col3, { color: res.status === 'clear' ? '#1A6B4A' : '#EF4444' }]}>
        ...
        <View style={{ marginTop: 30, backgroundColor: '#F0FDF4', padding: 15, borderRadius: 8 }}>
          ...
          <Text style={{ fontSize: 10, color: '#1A6B4A', marginTop: 5, lineHeight: 1.5 }}>
            {scan.recommendation}
          </Text>
        </View>
